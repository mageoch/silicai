...
_CIRCUIT_SCHEMA = "https://github.com/mageoch/silicai/schema/circuit.schema.json"
_PROJECT_SCHEMA = "https://github.com/mageoch/silicai/schema/project.schema.json"
